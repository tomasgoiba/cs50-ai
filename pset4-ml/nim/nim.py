...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        # Find best available action and return its Q-value
        key = lambda x: self.get_q_value(state, x)
        best_action = max(available_actions, key=key)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # Select random available action with probability `self.epsilon`
